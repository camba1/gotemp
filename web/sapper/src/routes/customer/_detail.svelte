<script>
    ...
    async function  handleSave() {
        ...
        if (ok) {
            if (isObjectEmpty(data)) {
                ...
                goto(addresses.reload + data.customer._key)
            } else {
                errorList = null
                detailData = data.customer
    ...
    function updateVF(event) {
        updateValidDate("validFrom", event.target.value, detailData.validityDates)
    }
    ...
    function updateVT(event) {
        updateValidDate("validThru", event.target.value, detailData.validityDates)
    }
        ...
        <Row>
            <GtDetailCard cardHeader="Information">
                <GtDetailCardFormGrp lblFor="id" lblText="Id:">
                    <Input id="id" class="form-control form-control-sm" name="id" type="text" readonly bind:value={detailData._key}/>
                </GtDetailCardFormGrp>
