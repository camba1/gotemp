<script>
    ...
    function validateData(){
        if (isNaN(detailData.approvalStatus) || detailData.approvalStatus === ""){
            detailData.approvalStatus = 0
        }
    }
    ...
    async function  handleSave() {
        ...
        if (ok) {
            if (isObjectEmpty(data)) {
                ...
                goto(addresses.reload + data.promotion.id)
            } else {
                errorList = null
                detailData = data.promotion
        ...
        <Row>
            <GtDetailCard cardHeader="Information">
                ...
                <GtDetailCardFormGrp lblFor="name" lblText="Name:">
                    <Input id="name" class="form-control form-control-sm"  name="name" type="text" readonly={false} bind:value={detailData.name}/>
                </GtDetailCardFormGrp>
                <GtDetailCardFormGrp lblFor="description" lblText="Description:">
                    <Input id="description" class="form-control form-control-sm"  name="description" type="text" readonly={false} bind:value={detailData.description}/>
                </GtDetailCardFormGrp>
            </GtDetailCard>
        ...
        <Row>
            ...
            <GtDetailCard cardHeader="Status">
                <GtDetailCardFormGrp lblFor="approvalStatus" lblText="Workflow:">
                    <Input id="approvalStatus" class="form-control form-control-sm"  name="approvalStatus" type="text" readonly={false} bind:value={detailData.approvalStatus}/>
                </GtDetailCardFormGrp>
