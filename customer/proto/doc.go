/*
proto package contains the definition of protobuffer messages and services related to the product service. Note that the
...
- the collection record but not in the protobuf definition. At the time of this writting this is a read only field
*/
package proto
